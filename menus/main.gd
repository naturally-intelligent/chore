...
func _ready():
	$Buttons/Play.connect("pressed", self, "on_play_pressed")
	$Buttons/Restart.connect("pressed", self, "on_restart_pressed")
	$Buttons/Credits.connect("pressed", self, "on_about_pressed")
	$Buttons/Notes.connect("pressed", self, "on_notes_pressed")
	$Buttons/Settings.connect("pressed", self, "on_settings_pressed")
	$Buttons/Quit.connect("pressed", self, "on_quit_pressed")
