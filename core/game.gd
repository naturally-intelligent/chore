...
onready var pixel_width = ProjectSettings.get_setting("display/window/size/width")
onready var pixel_height = ProjectSettings.get_setting("display/window/size/height")
